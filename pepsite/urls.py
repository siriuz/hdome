...
urlpatterns = patterns('',
    ...
    url(r'^ptm_peptide_search$', views.ptm_peptide_search, name='ptm_peptide_search'),
    ...
    url(r'^browsable_proteins_render_quicker$', views.browsable_proteins_render_quicker, name='browsable_proteins_render_quicker'),
    ...
    url(r'^expt2_ajax/(?P<expt_id>\d+)$', views.expt2_ajax_rapid, name='expt2_ajax'),
    ...
    url(r'^comparison_peptides_render$', views.comparison_peptides_render_rapid, name='comparison_peptides_render_rapid'),
    url(r'^searched_peptides_render$', views.searched_peptides_render, name='searched_peptides_render'),
    url(r'^searched_peptides_render_quicker$', views.searched_peptides_render_quicker, name='searched_peptides_render_quicker'),
    url(r'^send_expt_csv/(?P<expt_id>\d+)$', views.send_expt_csv, name='send_expt_csv'),
    url(r'^send_csv$', views.send_csv, name='send_csv'),
