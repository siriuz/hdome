...
urlpatterns = patterns('',
    ...
    url(r'^model_info/(?P<model_type>(Protein|Peptide|IdEstimate|Ptm|Ion|Experiment|Antibody|CellLine|Allele|Gene|Individual|Entity))/(?P<model_id>\d+)/$', views.model_info, name='model_info'),
